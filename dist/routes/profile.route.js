...
import { createProfileValidation, deleteProfileValidation, getProfileByIdValidation, updateProfileValidation, } from "../middleware/profile.validation.js";
 ...
 */
router.post("/", upload.single("profilePictureUrl"), validate(createProfileValidation), controller.create);
/**
 * @swagger
 * /profiles/{id}:
 *   put:
 ...
 */
router.put("/:id", upload.single("profilePicture"), validate(updateProfileValidation), controller.update);
/**
 * @swagger
 * /profiles/{id}:
 *   delete:
